...
contract Domains is ERC721URIStorage {
    ...
    constructor(string memory _tld)
        payable
        ERC721("Wizard Name Service", "WNS")
    {
        tld = _tld;
    ...
    function register(string calldata name) public payable {
        ...
        string memory json = Base64.encode(
            abi.encodePacked(
                '{"name": "',
                _name,
                '", "description": "A domain on the Wizard name service", "image": "data:image/svg+xml;base64,',
    ...
    function getRecord(string calldata property)
        public
        view
